...
public class SanityCheckTest {
    ...
    public void sanityVerticalSeamTest() {
        Picture p = new Picture("/home/czk/cs61b/skeleton-sp16/hw5/images/6x5.png");
        SeamCarver sc = new SeamCarver(p);

        double[][] energy = new double[5][6];
        for(int i = 0;i < 5;i++){
            for(int j = 0;j < 6;j++){
                energy[i][j] = sc.energy(j, i);
                System.out.println("The energy of (" + j + ", " + i + ")" +  "is" + energy[i][j]);
            }
        }
